...
def make_app():
    ...
    settings = dict(
        ...
        localfile_only_world_readable=options.localfile_only_world_readable,
...
def init_options():
    ...
    define("localfile_only_world_readable", default=False, help="Only serve files that are readable by 'Other' on the local file system", type=bool)
