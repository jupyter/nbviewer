...
def init_options():
    ...
    define("localfile_follow_symlinks", default=False, help="Use the absolute instead of the real path for local files, don't dereference symbolic links", type=bool)
